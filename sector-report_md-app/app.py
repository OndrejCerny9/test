...
def save_markdown_file(filename: str, content: str):
    ...
    return {
        ...
        "storage_note": "PoC only: file is saved in temporary local app storage.",
...
def download_file(filename: str):
    ...
    if not os.path.exists(file_path):
        return {"error": "File not found", "available_files": os.listdir(OUTPUT_DIR) if os.path.exists(OUTPUT_DIR) else []}
